            ...
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl">
                  Bestselling author of contemporary fiction, exploring the depths of human emotions and relationships.
                </p>
              </div>
            ...
            <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
              ...
              <div className="flex flex-col justify-center space-y-4">
                ...
                <p className="text-gray-500 md:text-xl">
                  ...
                  career spanning over a decade, she has captivated readers worldwide with her unique storytelling style
                  and deep understanding of the human psyche.
                </p>
                <p className="text-gray-500 md:text-xl">
              ...
              {[1, 2, 3].map((testimonial) => (
                <div key={testimonial} className="flex flex-col items-center space-y-2 text-center">
                  <p className="text-gray-500 italic">
                    &quot;Jane&apos;s writing is captivating and deeply moving. Her characters feel so real, I can&apos;t help but get
